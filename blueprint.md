...
EmojiWorld는 **이모지만으로** 전 세계 사람들과 소통하는 소셜 네트워크입니다. 텍스트를 없애 언어 장벽을 제거하고, "좋아요를 모으면 사진을 올릴 수 있는" 독자적인 루프로 인스타그램과 차별화합니다.
...
2. **v1.5:** EmojiWorld Plus — 프리미엄 이모지 팩·프로필 오라·부스트 (`/app/upgrade` UI 존재)
